...
const dataLine1 = {
  ...
  datasets: [{
    label: 'Km recorridos en Semana 297',
    data: [19, 15, 23, 18, 11, 15], // Datos de los km recorridos en cada día
...
const dataLine2 = {
  ...
  datasets: [{
    ...
    data: [18, 11, 19, 16, 17, 25], // Datos de los km recorridos en cada día    borderColor: 'rgba(153, 102, 255, 1)',
    fill: true,
    tension: 0.1
  }]
};
