...
const dataLine1 = {
  ...
  datasets: [{
    ...
    data: [11, 15, 15, 13, 32], // Datos de los km recorridos en cada día
...
const dataLine2 = {
  ...
  datasets: [{
    ...
    data: [18, 16, 14, 16, 17, 25], // Datos de los km recorridos en cada día    borderColor: 'rgba(153, 102, 255, 1)',
    fill: true,
    tension: 0.1
  }]
};
