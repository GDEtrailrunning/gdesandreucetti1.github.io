...
const dataLine1 = {
  ...
  datasets: [{
    ...
    data: [14, 13, 15, 13, 12, 23], // Datos de los km recorridos en cada día
...
const dataLine2 = {
  ...
  datasets: [{
    ...
    data: [10, 10, 13, 8, 10, 14], // Datos de los km recorridos en cada día
...
function actualizarDiasRestantes() {
  // Fecha objetivo fija
  const objetivoDate = new Date('2025-11-08');
