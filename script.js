...
const dataLine1 = {
  ...
  datasets: [{
    ...
    data: [15, 17, 18.4, 10, 16, 22], // Datos de los km recorridos en cada día
...
const dataLine2 = {
  ...
  datasets: [{
    ...
    data: [23, 18, 16, 14, 14, 16], // Datos de los km recorridos en cada día    borderColor: 'rgba(153, 102, 255, 1)',
    fill: true,
    tension: 0.1
  }]
};
