...
const dataLine1 = {
  ...
  datasets: [{
    ...
    data: [21, 15, 10, 13, 14, 26], // Datos de los km recorridos en cada día
...
const dataLine2 = {
  ...
  datasets: [{
    ...
    data: [14, 11, 15, 6, 14, 26], // Datos de los km recorridos en cada día    borderColor: 'rgba(153, 102, 255, 1)',
    fill: true,
    tension: 0.1
  }]
};
