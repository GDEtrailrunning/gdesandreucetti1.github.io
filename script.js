...
const dataLine1 = {
  ...
  datasets: [{
    ...
    data: [16, 17, 10, 12, 14, 25], // Datos de los km recorridos en cada día
...
const dataLine2 = {
  ...
  datasets: [{
    ...
    data: [12, 15, 19, 26, 17, 20], // Datos de los km recorridos en cada día
...
function actualizarDiasRestantes() {
  // Fecha objetivo fija
  const objetivoDate = new Date('2025-12-01');
